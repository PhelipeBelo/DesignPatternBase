...
import { Clock, RefreshCw, ChefHat, UtensilsCrossed } from 'lucide-react';
      ...
      <main className="mx-auto w-full max-w-6xl space-y-10">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {recipes.map((recipe) => (
            <Card 
              key={recipe.id} 
              className="group flex flex-col overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:hover:shadow-primary/5"
            >
              {/* Fake Image Cover */}
